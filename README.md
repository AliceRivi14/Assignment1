...
ou could use a `for loop` for every time you see a silver token, you move it and then you continue your path looking for the next.

```pseudocode
for each silver token:
	approach and move silver tokens until the silver token code is equal to N
	token code increases up to a maximum of N
	# N is the number of silver tokens
```		
